...
local UPDATE_FILE_PATH = LIB_PATH.."Riven.lua"
local UPDATE_URL = "https://"..UPDATE_HOST..UPDATE_PATH

function AutoupdaterMsg(msg) print("<font color=\"#6699ff\"><b>Riven:</b></font> <font color=\"#FFFFFF\">"..msg..".</font>") end
if AUTOUPDATE then
	local ServerData = GetWebResult(UPDATE_HOST, "/fter44/ilikeman/master/VersionFiles/Riven.version".."?rand="..math.random(1,10000))
	if ServerData then
...
local SPELL_DATA = { [_Q  ] = { skillshotType = SKILLSHOT_CONE,		range = 260, speed = 780, width = 50, delay=0.25},--Q1,Q2
					 ...
					 [_R  ] = { skillshotType = SKILLSHOT_CONE, 	range = 900, speed = 2000, width = 45*math.pi/180  , delay=0.25},
}
